...
% initialization\;
\For{(w1, w2) in wolf_routes} {
 \For{h in hare_routes}{
...
% initialization\;
 ...
 \For{all hare routes}{
  ...
  \Comment{compares each element}\;
  \Comment{in case of success probability-local++}\;
 }
 \parskip 12pt
 \noindent\hspace*{50mm} .\\
 \noindent\hspace*{50mm} .\\
...
% \KwResult{how to write algorithm with \LaTeX2e }
% initialization\;
  \If{probability-local $<$ probability-global}{
  	probability-global = probability-local\;
  	delete all elements in list\;
  	add $<$r1w1, r2w2$>$ to list\;  
   }
   \If{p-local $==$ p-global AND counter-local $<$ counter-global}{
...
\frametitle{Parallel}
\begin{itemize}
\item Sammle alle p-global und counter-global (MPI-Allgather)
